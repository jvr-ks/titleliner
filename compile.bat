...
@call "C:\Program Files\AutoHotkey\Compiler\Ahk2Exe.exe" /in titleliner.ahk /out titlelinerA32.exe /icon titleliner.ico /bin "C:\Program Files\AutoHotkey\Compiler\ANSI 32-bit.bin"
exit
